...
if(isset($_POST['change_password'])){
    ...
    //in case password len < 6
        ...
        if($stmt->execute()){
            header('location: account.php?message=password updated succesfully');
        }else{
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                <form id="account-form" method="POST" action="account.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="from-control" id="account-password" name="password" placeholder="password" required/>
                    </div>
                    <div class="form-group">
                        <label>Confirm Password</label>
                        <input type="password" class="from-control" id="account-password-confirm" name="confirmPassword" placeholder="Password" required/>
                    </div>
                    <div class="form-group">
